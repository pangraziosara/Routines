...
switch domain_str
    ...
    case 'sector'
        %cooprdinate polari, guardo raggio tra 0 e 1, guardo angolo
        %settore, se sono tutti nell'intervallo giusto allora il punto è
        %dentro.
        % prendo bounding box(quadratino che contiene il dominio), metto punti nella bounding box, voglio 200
        % punti random. Quindi nel dominio grande calcolo quanto il bb è
